...
const RECOVERY_EVENT_STUDY: RecoveryEventStudyData = {
  ...
  trajectories: [{
    ...
    sessionIds: [1],
    startedAts: ["2026-07-25T01:00:00.000Z"],
    ...
    eligible: true,
    points: [
      { date: "2026-07-24", offsetDays: -1, actual: 430, expectedCenter: 425, expectedRange: { low: 410, high: 440 }, delta: 5, controlCount: 8, recoveryExposures: [], excludedFromAggregate: false },
      { date: "2026-07-25", offsetDays: 0, actual: 455, expectedCenter: 430, expectedRange: { low: 415, high: 445 }, delta: 25, controlCount: 8, recoveryExposures: ["Hot blanket"], excludedFromAggregate: false },
      { date: TODAY, offsetDays: 1, actual: 440, expectedCenter: 432, expectedRange: { low: 418, high: 446 }, delta: 8, controlCount: 7, recoveryExposures: [], excludedFromAggregate: false },
    ],
  }],
  aggregate: [],
  durationResponses: Array.from({ length: 8 }, (_, offsetDays) => ({
    ...
    eligibleEvents: offsetDays < 2 ? 1 : 0,
    distinctDurations: offsetDays < 2 ? 1 : 0,
  ...
  timingResponses: Array.from({ length: 8 }, (_, offsetDays) => ({
    ...
    state: "insufficient_events",
    eligibleEvents: offsetDays < 2 ? 1 : 0,
    distinctTimings: offsetDays < 2 ? 1 : 0,
  ...
  caveats: ["Descriptive personal association only; unmeasured factors can explain a difference."],
};
...
const ROUTES: [RegExp, unknown][] = [
  ...
  [/\/api\/recovery\/event-study$/, RECOVERY_EVENT_STUDY],
